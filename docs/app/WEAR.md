...
This guide covers the basic commands for building and running the Wear OS version of the app.
...
3.  Navigate to your project's `/wear_app` folder.
...
From the `/wear_app` terminal, run:
